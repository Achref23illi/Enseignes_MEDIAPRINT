        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-5 space-y-12">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <h2 className="text-5xl lg:text-6xl font-light text-gray-900 leading-[1.1]">
                  ...
                  <br />
                  <span className="font-semibold" style={{color: '#EB2F46'}}>& Repair</span>
                </h2>
              ...
              <p className="text-lg text-gray-600 leading-relaxed max-w-md">
                Professional signage installation and maintenance services across Montreal. 
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                {[
                  { title: "Professional Installation", desc: "Expert mounting and positioning" },
                  { title: "Emergency Repairs", desc: "24/7 rapid response service" },
                  { title: "Preventive Maintenance", desc: "Regular inspections and upkeep" },
                  { title: "Permit Management", desc: "Complete regulatory compliance" }
                ].map((service, index) => (
          ...
          <div className="lg:col-span-7 relative">
            ...
            <div className="relative">
              ...
              <div className="absolute -left-8 top-1/4 bg-white rounded-xl shadow-lg border border-gray-100 p-6 max-w-xs hidden lg:block">
                ...
                <div className="text-xs text-gray-400">Professional certification and full insurance coverage for all installations</div>
              </div>
              ...
              <div className="absolute -right-8 bottom-1/4 bg-white rounded-xl shadow-lg border border-gray-100 p-6 max-w-xs hidden lg:block">
                ...
                <div className="text-xs text-gray-400">Emergency repairs and urgent installations completed within hours</div>
              </div>
