          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-8 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <button className="inline-flex items-center px-6 py-3 text-white font-semibold rounded-lg transition-colors duration-300" style={{backgroundColor: '#EB2F46'}} onMouseEnter={(e) => (e.target as HTMLElement).style.backgroundColor = '#f16d7a'} onMouseLeave={(e) => (e.target as HTMLElement).style.backgroundColor = '#EB2F46'}>
                  Learn More About Us
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
                          <button className="inline-flex items-center px-8 py-4 text-white font-semibold rounded-lg transition-all duration-300 hover:scale-105" style={{backgroundColor: '#EB2F46'}} onMouseEnter={(e) => (e.target as HTMLElement).style.backgroundColor = '#f16d7a'} onMouseLeave={(e) => (e.target as HTMLElement).style.backgroundColor = '#EB2F46'}>
